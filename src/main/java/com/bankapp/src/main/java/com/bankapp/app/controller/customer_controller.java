...
public class customer_controller {
	...
	public String getData(@Valid @RequestBody customer_m log_user){
	...
	public ResponseEntity<customer_m> update_user(@PathVariable int id, @Valid @RequestBody customer_m user_details){
