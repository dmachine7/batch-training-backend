...
public class transaction_m {
	...
	@Min(value = 1, message = "Trans Id field can't be empty.")
	private int trans_id;
	@Column(name = "send_acc",nullable = false)
	@NotEmpty(message = "Sender Account field can't be empty.")
	private String send_acc;
	@Column(name = "rec_acc",nullable = false)
	@NotEmpty(message = "Reciepient Account field can't be empty.")
	private String rec_acc;
	@Column(name = "trans_type",nullable = false)
	@NotEmpty(message = "Trans type field can't be empty.")
	private String trans_type;
	@Column(name = "trans_pass",nullable = false)
	@NotEmpty(message = "Trans pass field can't be empty.")
