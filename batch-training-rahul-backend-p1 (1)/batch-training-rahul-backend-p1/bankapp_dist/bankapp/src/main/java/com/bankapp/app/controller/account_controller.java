...
public class account_controller {
	...
	public String getData(@Valid @RequestBody account_m log_user){
	...
	//update/put mappings start
		...
		public ResponseEntity<account_m> update_user(@PathVariable int id,@Valid  @RequestBody account_m user_details){
